...
public class AbstractMarkLogicIT extends AbstractSpringMarkLogicTest {
    ...
    protected void setup() {
        ...
        for(int i = 0; i < numDocs; i++) {
            ...
            if(i % xmlMod == 0) {
                fileName += i + ".xml";
                content = "<root><sample>xmlcontent</sample><dateTime xmlns=\"namespace-test\">2000-01-01T00:00:00</dateTime></root>";
            } else if ( i % jsonMod == 0) {
                fileName += i + ".json";
                content = "{\"sample\":\"jsoncontent\", \"dateTime\":\"2000-01-01T00:00:00\"}";
            } else if (i % txtMod == 0) {
                fileName += i + ".txt";
